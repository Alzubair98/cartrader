<template>
  <div>
    ...
    >
      <a href="" class="text-3xl font-mono">cartreader</a>
    </header>
    <!-- NavBar -->
    ...
    >
      <div class="z-10 absolute w-full h-full flex justify-center items-center">
        <div class="text-center w-1/2">
          ...
          <!-- HOME SEARCH BAR-->
          <div
            class="font-serif w-[900px] text-2xl rounded-full bg-white flex justify-between overflow-hidden drop-shadow-2xl mx-auto"
          >
            <input
              type="text"
